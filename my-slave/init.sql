...
GRANT REPLICATION SLAVE ON *.* TO 'replicationuser'@'%' IDENTIFIED BY 'somepassword'
FLUSH PRIVILEGES; 

change master to master_host="mha-master", master_user="replicationuser", master_password="somepassword", master_auto_position=1;
